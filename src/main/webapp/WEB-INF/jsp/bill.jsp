...
<body>
	${error }
	<form action="paybills/${clientdetails.client_id }" method="post">
		<div class="container">
			<div class="card">
				...
				<table>
					<tr>
						<td>Payee Type</td>
						<td><select name="payee_type">
								<option value="creditcard_bill">Credit Card Bill</option>
								<option value="electricitybill">Electricity Bill</option>
								<option value="tutionfees">Tuition Fees</option>
								<option value="mobilebill">Mobile Bill</option>
						</select></td>
					</tr>
					<tr>
						<td>Payee Name</td>
						<td><input type="text" name="payee_name" /></td>
					</tr>
					<tr>
						<td>Payee Account Number</td>
						<td><input type="text" name="payee_account_number" /></td>
					</tr>
					<tr>
						<td>Pay From</td>
